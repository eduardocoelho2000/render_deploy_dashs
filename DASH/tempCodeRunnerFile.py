...
app.layout = html.Div(children=[
    ...
    dbc.Row([
        dbc.Col([
            dbc.Card([ 
            html.H2("Dash do Edu",style = {"font-family":"Voltaire","font-size":"20px"}),
            html.Hr(),      
            html.H4("Cidades:",style={"font-size": "20px"}),
            dcc.Checklist(df_data["City"].unique(),
            df_data["City"].unique(),id = "check_city", inputStyle= {"margin-right":"5px","margin-right": "10px" }),
            html.H4("Variável de Análise:",style={"font-size": "20px"}),
            dcc.RadioItems(["gross income","Rating"], "gross income",id = "main_variable"),],style = {"height": "90vh","margin":"20px","padding":"20px", }),], sm = 2),
        dbc.Col([
            dbc.Row([
